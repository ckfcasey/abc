...
# 載入中文字型
font_path = "font.otf"  # 替換為你的 font.otf 檔案路徑
font = FontProperties(fname=font_path, size=12)

# 設置 Matplotlib 使用中文字型
plt.rcParams['font.family'] = font.get_name()  # 設置字型
...
# 添加標籤和圖例
ax.text(-1.4, 1, f'介質1 (n1 = {n1})', fontproperties=font)
ax.text(-1.4, -1, f'介質2 (n2 = {n2})', fontproperties=font)
ax.legend(prop=font)
ax.set_xlabel('X', fontproperties=font)
ax.set_ylabel('Y', fontproperties=font)
ax.set_title('光線折射模擬', fontproperties=font)
